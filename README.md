...
To get started with Spotify for Developers and the Web API, visit https://developer.spotify.com/documentation/web-api and follow the 'Getting Started' instructions.
